...
const AddPage4 = ({ setButtonContinuer, t }) => {
		...
		<div>
			...
			<div className="formGroup select">
							...
							onChange = {handleLicence}>
								<option value="Default" disabled>{t("Licence d'utilisation de votre ressource")}</option>
							...
							<label htmlFor="dataStandard" className="formLabel">{t("Licence d'utilisation de votre ressource")}</label>
						</div> 
